    ...
    <div className="container mx-auto  bg-slate-600  w-12/12 py-5 ">
      ...
      <div className="container flex mt-10 mx-auto justify-center">
        <div className="flex flex-col lg:flex-row max-w-6xl rounded-lg bg-gray-300">
          <img className="lg:w-1/3 lg:h-[600px] md:rounded-none object-cover rounded-t-lg   h-96 md:rounded-l-lg " src="https://image.tmdb.org/t/p/w1280/rktDFPbfHfUbArZ6OOOKsXcv0Bm.jpg" alt="" />
